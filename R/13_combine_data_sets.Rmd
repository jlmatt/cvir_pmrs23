...
jul <- readRDS(here("data","derived", "july_data.rds"))
aug <- readRDS(here("data","derived", "aug_data.rds"))
sep <- readRDS(here("data","derived", "sep_data.rds"))

data <- bind_rows(oct,nov,dec,jan,feb,mar,apr,may,jun,jul,aug,sep)
```
